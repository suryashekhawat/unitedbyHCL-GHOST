...
class Mario(pg.sprite.Sprite):
    ...
    def ghostMessage(msg):
        c.AI_MESSAGE = 'let\'s go'.upper()
    ...
    def handle_state(self, keys, fire_group):
        ...
        if self.state == c.STAND:
            ...
            c.AI_MESSAGE = 'lets go mario'.upper()
            
        elif self.state == c.WALK:
            self.walking(keys, fire_group)
            c.AI_MESSAGE = "Ok lets find mashroom".upper()
            
        elif self.state == c.JUMP:
            self.jumping(keys, fire_group)
            c.AI_MESSAGE = "Ok thats a good try".upper()
        elif self.state == c.FALL:
            self.falling(keys, fire_group)
            c.AI_MESSAGE = "Ohhh no".upper()
            
        elif self.state == c.DEATH_JUMP:
            self.jumping_to_death()
            c.AI_MESSAGE = "lets play it again".upper()
            
        elif self.state == c.SMALL_TO_BIG:
            self.changing_to_big()
            c.AI_MESSAGE = "ohh cool now grab some power".upper()
        elif self.state == c.BIG_TO_FIRE:
            self.changing_to_fire()
            c.AI_MESSAGE = "oh you got it cool".upper()
            setup.SFX['letsgomario'].play()

        elif self.state == c.BIG_TO_SMALL:
            self.changing_to_small()
            c.AI_MESSAGE = "oh no".upper()
            
        elif self.state == c.FLAGPOLE:
            self.flag_pole_sliding()
            c.AI_MESSAGE = "yeaaah we won".upper()
            setup.SFX['wewon'].play()
        elif self.state == c.BOTTOM_OF_POLE:
            self.sitting_at_bottom_of_pole()
            c.AI_MESSAGE = "love y mario".upper()
            ...
            c.AI_MESSAGE = "oh no game over bye".upper()
            setup.SFX['gameover'].play()
    ...
    def shoot_fireball(self, powerup_group):
        ...
        c.AI_MESSAGE = "kill them all".upper()
