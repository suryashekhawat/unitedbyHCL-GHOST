...
class Enemy(pg.sprite.Sprite):
    ...
    def handle_state(self):
        ...
        if self.state == c.WALK:
            self.walking()
            c.AI_MESSAGE='Enemy coming'.upper()
        elif self.state == c.FALL:
            self.falling()
            c.AI_MESSAGE='gone yeah'.upper()
        elif self.state == c.JUMPED_ON:
            self.jumped_on()
            c.AI_MESSAGE='yeah killed super'.upper()
        elif self.state == c.SHELL_SLIDE:
            self.shell_sliding()
            c.AI_MESSAGE='tuuu mario'.upper()
        elif self.state == c.DEATH_JUMP:
            self.death_jumping()
            c.AI_MESSAGE='killer jump mario'.upper()
