...
class OverheadInfo(object):
    ...
    def draw(self, surface):
        ...
        if self.state == c.MAIN_MENU:
            ...
            self.draw_mario_ai_bot(surface)
        elif self.state == c.GAME_OVER:
    ...
    def draw_mario_ai_bot(self, surface):
        self.bot_message_label = []
        self.create_label(self.bot_message_label, c.AI_MESSAGE, 250,295)
        for bot in self.bot_message_label:
            surface.blit(bot.image, bot.rect)
